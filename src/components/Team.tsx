          ...
          <div className="grid grid-cols-1 md:grid-cols-12">
            <div className="md:col-span-8 md:order-1 order-2" style={{ padding: "clamp(1.5rem, 3vw, 2.5rem)", paddingRight: "clamp(2rem, 3vw, 3rem)", display: "flex", flexDirection: "column", justifyContent: "center" }}>
              ...
              <p style={{ fontSize: "0.85rem", fontWeight: 300, color: "var(--stone-dark)", lineHeight: 1.85, marginBottom: "1.5rem" }}>
                Has built and designed multiple businesses from the ground up — the operational systems, the brand, and the front-end and back-end that each one runs on. Co-founded Biotrofi, with years of experience shipping brand, web, and operational systems across hospitality and lifestyle ventures.
              </p>
              <div style={{ display: "flex", flexWrap: "wrap", gap: "0.35rem" }}>
                {[
